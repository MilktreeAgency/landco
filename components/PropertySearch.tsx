...
export const PropertySearch = () => {
  ...
  return (
    <div className="pt-24 min-h-screen bg-slate-50">
      {/* Search Header */}
      <div className="bg-white border-b border-slate-200 px-6 py-8 sticky top-20 z-30">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            <div>
              <h1 className="text-3xl font-display font-black text-slate-900">Find Your Yard</h1>
              <p className="text-slate-500 mt-1">Discover available industrial storage across the UK</p>
            </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-grow relative">
              ...
              <input 
                ...
                className="w-full pl-12 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:border-landco-yellow focus:ring-2 focus:ring-landco-yellow/20 transition-all text-slate-900 font-medium"
              />
              {searchTerm && (
                <button 
