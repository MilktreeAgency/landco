  ...
  return (
    <section className="relative min-h-[100vh] flex flex-col items-center justify-center overflow-hidden bg-gradient-hero">
      ...
      <div className="relative z-10 w-full max-w-6xl px-6 text-center">
        ...
        <div className={`relative max-w-2xl mx-auto mb-16 transition-all duration-700 delay-300 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="bg-white p-2 flex items-center shadow-2xl rounded-xl border border-white/10 relative z-20">
                ...
                {filteredCities.map((city) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">{city.region} • {city.description}</p>
                    </div>
                  </button>
                ))}
              </div>
